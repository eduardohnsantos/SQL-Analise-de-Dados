...
ALTER TABLE temp_tables.profissoes
RENAME COLUMN status_professional TO status_profissional;

UPDATE temp_tables.profissoes
SET status_profissional = REPLACE(status_profissional, 'aposentado()a', 'aposentado(a)')
WHERE status_profissional LIKE '%aposentado()a%';
